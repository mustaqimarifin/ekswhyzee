...
export async function getRssXml() {
  ...
  const blogUrl = 'https://ekswhyzee.vercel.app/blog';
  ...
  return `
    <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:blogChannel="${blogUrl}">
      <channel>
        <title>Mustaqim Arifin Blog</title>
        <link>${blogUrl}</link>
        <description>The Mustaqim Arifin Blog, thoughts, mental models, and tutorials about front-end development.</description>
