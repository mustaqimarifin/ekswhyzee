...
<SplitImage>
  <Split>
    <CloudinaryImg
      mdx
      className='!mb-0'
      publicId='mstqmarfn/projects/ppdbsumsel/prestasi-tesmandiri_zjaaer'
    ...
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/ppdbsumsel/acceptance_tvjpmi'
      alt='acceptance'
      width={1280}
      height={908}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className='!mb-0'
      publicId='mstqmarfn/projects/ppdbsumsel/zonasi_djqq65'
      alt='zonasi'
      width={1440}
      height={2537}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/ppdbsumsel/not-accepted_gxl5qm'
      alt='not-accepted'
      width={1280}
      height={826}
    />
...
We also configured it with husky so the commit message is checked before committing. You can check the setup on my library about [how to configure husky](https://ekswhyzee.vercel.app/library/husky-commitlint-prettier)

<CloudinaryImg
  mdx
  publicId='mstqmarfn/projects/ppdbsumsel/conventional-commit_e8z1qa'
