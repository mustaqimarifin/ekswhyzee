...
github: 'https://github.com/mustaqimarifin/petrolida-2021'
---
...
<SplitImage>
  <Split>
    <CloudinaryImg
      mdx
      className='!mb-0'
      publicId='mstqmarfn/petrolida-2021/ss1_pvyttb.png'
      width={800}
      height={2366}
      alt='Web Screenshot'
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className='!mb-0'
      publicId='mstqmarfn/petrolida-2021/ss2_fpine4.png'
      width={800}
      height={2782}
      alt='Web Screenshot'
    />
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/petrolida-2021/opengraph_prie5d'
  alt='opengraph'
  width={315}
  height={227}
/>
