...
github: 'https://github.com/mustaqimarifin/seasfor.us'
youtube: '#demo-video'
---
...
<SplitImage>
  <Split>
    <CloudinaryImg
      mdx
      className='!mb-0'
      publicId='mstqmarfn/projects/seasforus/landing-page_snz4rm'
      alt='landing-page'
      width={800}
      height={426}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/login_cpx0l0'
      alt='login'
      width={800}
      height={424}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/join_vljir9'
      alt='join'
      width={800}
      height={424}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/myevents_rqfytp'
      alt='myevents'
      width={1439}
      height={767}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      className='!mb-0'
      publicId='mstqmarfn/projects/seasforus/events-page_eoumfe'
      alt='events-page'
      width={800}
      height={397}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/filter_hkzi0u'
      alt='filter'
      width={800}
      height={427}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/post-activity_r3o9qz'
      alt='post-activity'
      width={800}
      height={425}
    />
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/leaderboard_wnedjz'
      alt='leaderboard'
      width={1441}
      height={765}
    />
...
<SplitImage>
  <Split>
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/winner-runnerup_d6n2c1'
      alt='winner-runnerup'
      width={1920}
      height={1080}
    />
  ...
  <Split>
    <CloudinaryImg
      mdx
      publicId='mstqmarfn/projects/seasforus/winner-auth0_xx8wm9'
      alt='winner-auth0'
      width={1920}
      height={1080}
    />
...
Definitely, time is a problem, but Rizqi (front-end) and I, sprinted all of the UI and layout in just about 12 hours, we constantly work in a Zoom call so the process is fairly quick. I also use my [Starter Repo](https://github.com/mustaqimarifin/ts-nextjs-tailwind-starter) which helps a lot to get it started.
...
- [Mustaqim Arifin](https://github.com/mustaqimarifin): Front-end and Design
