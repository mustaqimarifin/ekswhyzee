...
github: 'https://github.com/mustaqimarifin/sxceosleague'
---
...
<SplitImage>
  <Split>
    <CloudinaryImg
      className='!mb-0'
      publicId='mstqmarfn/sxceosleague/ss1_wgdcwp.png'
      alt='Screenshot 1'
      width={800}
      height={1271}
    />
  ...
  <Split>
    <CloudinaryImg
      className='!mb-0'
      publicId='mstqmarfn/sxceosleague/ss2_lrhcjn.png'
      width={800}
      height={1023}
      alt='Web Screenshot'
    />
    <CloudinaryImg
      publicId='mstqmarfn/sxceosleague/ss3_orb5oe.png'
      width={800}
      height={440}
      alt='Web Screenshot'
    />
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/sxceosleague/ss4_hqmquo'
  alt='ss4'
  width={450}
  height={792}
/>
