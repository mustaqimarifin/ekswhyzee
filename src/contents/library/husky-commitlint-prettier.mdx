...
1. Checking the commit message following the [conventional commits](https://ehkswhyz.vercel.app/library/conventional-commit-readme), it will fail to commit if the commit message is not following the rule.
