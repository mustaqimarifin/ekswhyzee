...
Commit message akan dicek menggunakan [husky and commit lint](https://ekswhyzee.vercel.app/library/husky-commitlint-prettier), jika convention salah, maka tidak bisa melakukan commit
