...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flexbox-grid/1_aa0dum.png'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flexbox-grid/2_spnrcs.png'
  alt='Contoh bagi dua'
  width={1440}
  height={702}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flexbox-grid/3_xefqrr.png'
  alt='Contoh item tengah'
  width={1440}
  height={50}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flexbox-grid/4_t3tnuj.png'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flexbox-grid/5_i0mfuw.png'
  alt='Layout kanan kiri'
  width={1425}
  height={712}
/>
