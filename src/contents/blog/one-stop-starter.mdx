...
2. **commit-msg**, run commitlint to ensure the use of the [Conventional Commit](https://ekswhyz.vercel.app/library/conventional-commit-readme) for commit messages
...
- [Storybook](https://ekswhyz.vercel.app/blog/nextjs-storybook-tailwind)
- Cypress + workflow to run on Vercel preview on push
- [Toast with React Query / SWR](https://ekswhyz.vercel.app/blog/react-loading-state-pattern)
