...
2. **commit-msg**, run commitlint to ensure the use of the [Conventional Commit](https://ehkswhyz.vercel.app/library/conventional-commit-readme) for commit messages
...
- [Storybook](https://ehkswhyz.vercel.app/blog/nextjs-storybook-tailwind)
- Cypress + workflow to run on Vercel preview on push
- [Toast with React Query / SWR](https://ehkswhyz.vercel.app/blog/react-loading-state-pattern)
