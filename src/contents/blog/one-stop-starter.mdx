...
englishOnly: 'true'
banner: 'mxm_inv_ztawwh'
tags: 'nextjs,tailwindcss,typescript'
---

## Introduction

I made the [ts-nextjs-tailwind-starter](https://github.com/mustaqimarifin/ts-nextjs-tailwind-starter) after I got tired of setting up a new project and have to initialize Tailwind CSS every single time. After some months, this starter has grown and is filled with a lot of development automation and tools that help me when I'm developing.
...
- 👀 Default Open Graph — Awesome open graph generated using [og.thcl.dev](https://github.com/mustaqimarifin/og), fork it, and deploy!
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/initial-config_oaxcgp'
  alt='initial-config'
  width={1405}
  height={993}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/list-of-tailwind-classes_jqwdxa'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/seo-component_xpzsab'
  alt='seo-component'
  width={1501}
  height={921}
/>
...
2. **commit-msg**, run commitlint to ensure the use of the [Conventional Commit](https://ekswhyzee.vercel.app/library/conventional-commit-readme) for commit messages
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/inline-lint_h8zjrn'
  alt='inline-lint'
  width={828}
  height={623}
/>
...
I also provided an open graph application that you can [fork and deploy to vercel](https://github.com/mustaqimarifin/og) for **free**. It is automatically used with the SEO component and will generate a dynamic open graph based on the page title and description.
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/og-generate_kcbpzt'
  alt='og-generate'
  width={1191}
  height={884}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/snippets_i9vgeg'
  alt='snippets'
  width={887}
  height={907}
/>

See more detail on [this file](https://github.com/mustaqimarifin/ts-nextjs-tailwind-starter/blob/main/.vscode/typescriptreact.code-snippets)
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/one-stop-starter/regions_ws4imm'
  alt='regions'
  width={1307}
  height={415}
/>
...
Currently, there are some packs in the [expansion-pack repository](https://github.com/mustaqimarifin/expansion-pack)

- React Hook Form + Form Input Components
- [Storybook](https://ekswhyzee.vercel.app/blog/nextjs-storybook-tailwind)
- Cypress + workflow to run on Vercel preview on push
- [Toast with React Query / SWR](https://ekswhyzee.vercel.app/blog/react-loading-state-pattern)
- [Dialog Manager with Zustand](https://github.com/mustaqimarifin/dialog-manager)
- NProgress
...
For more demo, check out the [repository readme](https://github.com/mustaqimarifin/expansion-pack)

<GithubCard repo='theodorusclarence/expansion-pack' />

## Star the repository

Liking the features? This repository basically grows with me, so the features will go through changes and improvement. If you got anything in mind, leave a comment below, or [open a discussion](https://github.com/mustaqimarifin/ts-nextjs-tailwind-starter/discussions).
