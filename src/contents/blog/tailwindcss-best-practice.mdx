...
Tailwind CSS is a utility-first framework that is currently my go-to framework for styling on my website. It provides reusable styling and components that I can even use between multiple websites. Checkout [my library](https://ekswhyz.vercel.app/library), I have some of my components put there so I can easily find them when I need them on another website I'm building.
...
It uses relative units so it will be relative to the element's font size. Learn more about this in my [blog about rem, em, and px units](https://ekswhyz.vercel.app/blog/btb-rem-em)
...
Notice the use of space between to reduce class too. The code example is taken from this website and [available on github](https://github.com/theodorusclarence/ekswhyz.vercel.app). Kindly star it if it helps!
