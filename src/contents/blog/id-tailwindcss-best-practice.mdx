...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/tailwindcss-best-practice/layout_olnbd1'
  alt='layout'
  width={1000}
  height={489}
/>
...
Lobotomized Owl biasanya menggunakan relative units sehingga besarnya relatif pada font size containernya. Untuk mengetahui relative units lebih lanjut, baca [blog saya tentang rem, em, dan px unit](https://ekswhyzee.vercel.app/blog/btb-rem-em)
...
Notice penggunaan space between untuk mereduce class yang digunakan. Code ini saya ambil dari website ini, codenya dapat [diakses di github](https://github.com/theodorusclarence/ekswhyzee.vercel.app). Kindly star kalo membantu!
