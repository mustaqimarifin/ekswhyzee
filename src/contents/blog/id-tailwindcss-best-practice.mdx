...
Notice penggunaan space between untuk mereduce class yang digunakan. Code ini saya ambil dari website ini, codenya dapat [diakses di github](https://github.com/mustaqimarifin/ekswhyzee.vercel.app). Kindly star kalo membantu!
