...
Lobotomized Owl biasanya menggunakan relative units sehingga besarnya relatif pada font size containernya. Untuk mengetahui relative units lebih lanjut, baca [blog saya tentang rem, em, dan px unit](https://ehkswhyz.vercel.app/blog/btb-rem-em)
...
Notice penggunaan space between untuk mereduce class yang digunakan. Code ini saya ambil dari website ini, codenya dapat [diakses di github](https://github.com/theodorusclarence/ehkswhyz.vercel.app). Kindly star kalo membantu!
