...
I added a dismiss button because it doesn't have it by default, you can grab the `DismissableToast` code from [my library](https://ekswhyz.vercel.app/library/toast#dismissabletoast).
