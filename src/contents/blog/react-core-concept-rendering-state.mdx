...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/javascript-demo-codepen_mr6iip'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/3-actions-js_uwzw7v'
  alt='3-actions-js'
  width={952}
  height={762}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/button-split-mutate-render_pixdof'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/render-function_eyhzo4'
  alt='render-function'
  width={800}
  height={496}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/simulating-render-function_x0em6n'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/declaring_outside_component_zaadd7'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/does-it-work_l5glbn'
  alt='does-it-work'
  width={644}
  height={800}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/using-usestate_fbrjod'
  alt='using-usestate'
  width={595}
  height={800}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/react-core-concept-rendering-state/3-actions-with-react_s77vmf'
