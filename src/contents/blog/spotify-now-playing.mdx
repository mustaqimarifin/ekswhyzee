...
If you want the TypeScript version, checkout the code on [GitHub](https://github.com/theodorusclarence/ekswhyzee.vercel.app/blob/main/src/pages/api/spotify.ts)
