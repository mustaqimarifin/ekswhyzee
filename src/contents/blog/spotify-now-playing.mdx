...
If you want the TypeScript version, checkout the code on [GitHub](https://github.com/theodorusclarence/ehkswhyz.vercel.app/blob/main/src/pages/api/spotify.ts)
...
You can check out the live deployment on [spotify-playing.ehkswhyz.vercel.app](https://spotify-playing.ehkswhyz.vercel.app)
