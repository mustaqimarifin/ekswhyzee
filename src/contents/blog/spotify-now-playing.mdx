...
If you need a reference to create the app, you can [check my repository](https://github.com/mustaqimarifin/now-playing-spotify). Don't forget to star it!

You can also use my [nextjs-tailwind-starter](https://github.com/mustaqimarifin/nextjs-tailwind-starter) by using:
...
If you want the TypeScript version, checkout the code on [GitHub](https://github.com/mustaqimarifin/ekswhyzee.vercel.app/blob/main/src/pages/api/spotify.ts)
...
You can check out the live deployment on [spotify-playing.ekswhyzee.vercel.app](https://spotify-playing.ekswhyzee.vercel.app)
