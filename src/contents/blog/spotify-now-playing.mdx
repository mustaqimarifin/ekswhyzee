...
If you want the TypeScript version, checkout the code on [GitHub](https://github.com/theodorusclarence/ekswhyz.vercel.app/blob/main/src/pages/api/spotify.ts)
...
You can check out the live deployment on [spotify-playing.ekswhyz.vercel.app](https://spotify-playing.ekswhyz.vercel.app)
