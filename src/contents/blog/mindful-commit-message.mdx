...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/mindful-commit-message/0-bad-example_lf3eop'
  alt='0-bad-example'
  width={508}
  height={284}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/mindful-commit-message/1-standard-version_rhrvwc'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/mindful-commit-message/2-changelog_i5qge7'
  alt='2-changelog'
  width={977}
  height={371}
/>
...
Commit message will be checked using [husky and commit lint](https://ekswhyzee.vercel.app/library/husky-commitlint-prettier), you can't commit if not using the proper convention below.
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/mindful-commit-message/3-commitlint_cxclqa'
  alt='3-commitlint'
  width={752}
  height={300}
/>
...
Check out this [post](https://ekswhyzee.vercel.app/library/husky-commitlint-prettier#2-add-commitlint) to add Commitlint using Husky
