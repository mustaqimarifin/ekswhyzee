...
There you go, after I understand how flexbox actually works, working with flexbox is a breeze. I also have a blog post on [how to choose between flex and grid](https://ehkswhyz.vercel.app/blog/btb-flexbox-grid), you might want to check it out.
