---
title: 'Back To Basics: Mental Model & FlexBox '
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/Flex_Direction_wp5tpx.png'
  alt='Flex Direction'
  width={750}
  height={832}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/Spreadsheet_pljkqc.png'
  alt='Spreadsheet'
  width={1155}
  height={256}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/justify_content_uelnhn'
  alt='justify'
  width={401}
  height={641}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/align-items_mnzy9w'
  alt='align-items'
  width={405}
  height={535}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/flexbox-divide_xupnpf'
  alt='flexbox-divide'
  width={536}
  height={156}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/larger_jkzrud'
  alt='larger'
  width={719}
  height={111}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/divide_equal_nnad59'
  alt='divide'
  width={415}
  height={112}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/firefox-devtools_nzmwpm'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/different_request_xoxazj'
  alt='different'
  width={715}
  height={204}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/btb-flex-mental-model/flex-grow-width_p8sksq'
  alt='flex-grow-width'
  width={544}
  height={534}
/>
...
There you go, after I understand how flexbox actually works, working with flexbox is a breeze. I also have a blog post on [how to choose between flex and grid](https://ekswhyzee.vercel.app/blog/btb-flexbox-grid), you might want to check it out.
