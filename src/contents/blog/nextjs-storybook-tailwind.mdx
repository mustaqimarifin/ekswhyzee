...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/nextjs-storybook-tailwind/button-storybook-preview_gibxko'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/nextjs-storybook-tailwind/vercel-deploy-config_gtv6ib'
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/nextjs-storybook-tailwind/starter-features_zu6nfk'
  alt='starter-features'
  width={864}
  height={697}
/>

Check out the [ts-nextjs-tailwind-starter](https://github.com/mustaqimarifin/ts-nextjs-tailwind-starter)!
...
[Expansion pack repository](https://github.com/mustaqimarifin/expansion-pack#storybook)

### Plop Generator

The expansion pack is also equipped with a [plop](http://plopjs.com?ref=ekswhyzee.vercel.app) generator to easily create a storybook file for your component
