...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/rhf/rhf-1_m2z3ia.png'
  alt='Demo Screenshot'
  width={880}
  height={438}
/>
...
> I'm open for all suggestions and contributions to improve 🚀. Open a PR on the repository (available on the demo website) or email me at me@ekswhyzee.vercel.app
