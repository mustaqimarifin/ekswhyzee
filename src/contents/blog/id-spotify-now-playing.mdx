...
banner: 'xyz_1200_vizriq'
tags: 'nextjs'
---

## Introduction

Pada website ekswhyzee.vercel.app, saya menggunakan sebuah API dari Spotify untuk menunjukkan lagu apa yang sedang saya putar secara live. Sekarang, saya akan memberitahu bagaimana cara membuat persis seperti yang saya tunjukkan dengan menggunakan Next.js.
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/spotify-playing_sx0rej'
  alt='spotify-playing'
  width={656}
  height={410}
/>

[Website Demo](https://spotify-playing.ekswhyzee.vercel.app)
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/2_jbfz2i.png'
  alt='Dashboard'
  width={1437}
  height={795}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/3_pcmoan.png'
  alt='Client Info'
  width={493}
  height={323}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/4_c4ol4r.png'
  alt='Edit Settings'
  width={1437}
  height={795}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/5_ynbc2q.png'
  alt='Redirect URI'
  width={1440}
  height={891}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/6_jkbqaa.png'
  alt='Base64 Encode'
  width={784}
  height={619}
/>
...
<CloudinaryImg
  mdx
  publicId='mstqmarfn/blogs/spotify-now-playing/7_rud11r.png'
  alt='Terminal'
  width={920}
  height={494}
/>
...
Jika kamu butuh referensi untuk membuat aplikasi, kamu bisa [cek repository saya](https://github.com/mustaqimarifin/now-playing-spotify). Jangan lupa di star ya!

Kamu bisa menggunakan [nextjs-tailwind-starter](https://github.com/mustaqimarifin/nextjs-tailwind-starter) dengan command:

```bash
npx create-next-app -e https://github.com/mustaqimarifin/nextjs-tailwind-starter project-name
```
...
Jika anda ingin code TypeScript, anda bisa mengecek codenya di [GitHub](https://github.com/mustaqimarifin/ekswhyzee.vercel.app/blob/main/src/pages/api/spotify.ts)
...
[TypeScript Version](https://github.com/mustaqimarifin/ekswhyzee.vercel.app/blob/main/src/components/layout/Spotify.tsx)
...
Hasil bisa dilihat di [spotify-playing.ekswhyzee.vercel.app](https://spotify-playing.ekswhyzee.vercel.app)
