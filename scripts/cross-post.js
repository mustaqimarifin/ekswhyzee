...
> Originally posted on [my personal site](https://ekswhyzee.vercel.app/?ref=devto), find more [blog posts](https://ekswhyzee.vercel.app/blog?ref=devto) and [code snippets library](https://ekswhyzee.vercel.app/library?ref=devto) I put up for easy access on my site 🚀

Like this post? [Subscribe to my newsletter](https://ekswhyzee.vercel.app/subscribe?ref=devto) to get notified every time a new post is out!`;

const hashnodeFooter = `
---

> Originally posted on [my personal site](https://ekswhyzee.vercel.app/?ref=hashnode), find more [blog posts](https://ekswhyzee.vercel.app/blog?ref=hashnode) and [code snippets library](https://ekswhyzee.vercel.app/library?ref=hashnode) I put up for easy access on my site 🚀

Like this post? [Subscribe to my newsletter](https://ekswhyzee.vercel.app/subscribe?ref=hashnode) to get notified every time a new post is out!`;
//#endregion  //*======== Footers ===========
...
const devto = () => {
  ...
  readFile(fileName, 'utf8', (err, content) => {
    ...
    parsedContent = parsedContent.replace(
      CLOUDINARY_REGEXP,
      '![$2](https://res.cloudinary.com/mstqmarfn/image/upload/q_auto,f_auto/$1)'
    );
    parsedContent = parsedContent.replace(
      GITHUB_REGEXP,
      '{% github $1 no-readme %}'
...
const getOgImage = () => {
  readFile(fileName, 'utf8', (err, content) => {
    ...
    const bannerLink = `https://res.cloudinary.com/mstqmarfn/image/upload/f_auto,c_fill,ar_4:5,w_1200/theodorusclarence/banner/${frontmatter.banner}`;
